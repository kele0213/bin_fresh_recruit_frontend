...
import type {ComStartChatRequest, FreshGetChatRequest, FreshStartChatRequest} from "@/service/chat/type";
...
export const useChatStore = defineStore('chatStore', () => {
    ...
    return {
        latelyFresh, getLatelyFreshList, changFreshId, freshInfo, comSend, chatList, getChatList,
        latelyCom, getLatelyComList, changeComId, comInfo, freshSend
    };
})